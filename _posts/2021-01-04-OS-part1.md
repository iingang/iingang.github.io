---
title: "[운영체제] 운영체제 및 컴퓨터 시스템 기본 요소"
author: Ingyung Park
...
## **Input/Output Address Register (I/O AR) = 입출력 주소 레지스터**
...
## **Input/Output Buffer Register (I/O BR) = 입출력 버퍼 레지스터**
